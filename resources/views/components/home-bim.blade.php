<div class="text-black py-32">
    <div class="flex flex-col items-center justify-center gap-8 px-12">
        <h1 class="text-3xl">@lang('homepage.bim')</h1>
        <div class="parahraph">
            <p>@lang('homepage.bimdesc1')</p>
        </div>
        <div class="parahraph">
            <p>@lang('homepage.bimdesc2')</p>
        </div>
        <div class="parahraph">
            <p>@lang('homepage.bimdesc3')</p>
        </div>
