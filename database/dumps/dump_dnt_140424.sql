...
CREATE TABLE public.components (
    ...
    view_file character varying(255) NOT NULL,
    content json,
...
356a192b7913b04c54574d18c28d46e6395428ab:timer	i:1713101296;	1713101296
356a192b7913b04c54574d18c28d46e6395428ab	i:1;	1713101296
\.
...
COPY public.components (id, name, view_file, content, created_at, updated_at) FROM stdin;
2	slider	standard.fashion-slider	{\n        "slide": {\n            "title": "text",\n            "desc": "text",\n            "img": "filename",\n            "bg-color": "hex-color"\n        }\n    }	2024-04-14 14:40:25	2024-04-14 14:40:25
\.
...
COPY public.files (id, name, path, type, size, created_at, updated_at) FROM stdin;
21	karaganda.webp	uploads/keSciV41jlPCpKYNYf7kVNef73rH4AlOB4zxTXif.webp	webp	302752	2024-04-14 13:27:19	2024-04-14 13:27:19
22	hydepark.webp	uploads/UtNDxUSANKIIrFv40VHg4Bdeuvpngi0fNq0dYLoy.webp	webp	184466	2024-04-14 13:27:19	2024-04-14 13:27:19
23	bank.webp	uploads/GSzGqcc3oZXfbIC7EptuSRPrp2ONHXLAqVUacbLr.webp	webp	279530	2024-04-14 13:27:19	2024-04-14 13:27:19
\.
...
4	2024_04_08_200238_create_customer_columns	2
5	2024_04_08_200239_create_subscriptions_table	2
6	2024_04_08_200240_create_subscription_items_table	2
7	2024_04_12_113526_create_templates_table	3
8	2024_04_12_113527_create_pages_table	3
9	2024_04_12_115416_create_translations_table	4
10	2024_04_14_114923_create_files_table	5
11	2024_04_14_141229_create_components_table	6
\.
...
COPY public.pages (id, title, slug, content, template_id, created_at, updated_at) FROM stdin;
11	Homepage	home	{}	8	2024-04-13 14:57:21	2024-04-13 14:57:21
\.
...
tvIWPLQ4sPu5ScwdlNHkriCO0xr25PSL9k92uMl0	1	127.0.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36		1713108294
\.
...
COPY public.subscription_items (id, subscription_id, stripe_id, stripe_product, stripe_price, quantity, created_at, updated_at) FROM stdin;
\.
...
COPY public.templates (id, name, view_file, created_at, updated_at) FROM stdin;
8	Root Layout	main	2024-04-13 14:56:48	2024-04-13 14:56:48
\.
...
COPY public.translations (id, key, value, language_code, created_at, updated_at) FROM stdin;
\.
...
COPY public.users (id, name, email, email_verified_at, password, remember_token, created_at, updated_at, stripe_id, pm_type, pm_last_four, trial_ends_at) FROM stdin;
1	Bogdan	el.touch.shop@gmail.com	\N	$2y$12$ad0fDMrlqwvCK7AmwD1H1O59ZQSVvEUqUnyLmSVZa1QuafWu5yKci	\N	2024-04-08 15:53:25	2024-04-08 15:53:25	\N	\N	\N	\N
\.
...
--
-- Name: translations translations_key_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.translations
    ADD CONSTRAINT translations_key_unique UNIQUE (key);
...
--
-- Name: pages pages_template_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pages
    ADD CONSTRAINT pages_template_id_foreign FOREIGN KEY (template_id) REFERENCES public.templates(id) ON DELETE CASCADE;
